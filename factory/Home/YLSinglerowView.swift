...
extension YLSinglerowView : UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if tagSource!.count > 0 {
            cell.tagLabel?.attributedText=FuWenBen()
...
//            }
    ...
    func FuWenBen() -> NSMutableAttributedString {
        ...
        //图片
        let smileImage  = UIImage.init(named: "new_gao")
...
extension YLSinglerowView {
    ...
    fileprivate func addSinglerViewTimer() {
        ...
        RunLoop.main.add(singlerTimer!, forMode: .common)
    }
    ...
    @objc fileprivate func scrollToNextPage() {
        ...
        if style == ScrollStyle.right || style == ScrollStyle.left {
            position = style == .left ? UICollectionView.ScrollPosition.left : UICollectionView.ScrollPosition.right
        }else {
            position = style == .up ? UICollectionView.ScrollPosition.top : UICollectionView.ScrollPosition.bottom
        }
