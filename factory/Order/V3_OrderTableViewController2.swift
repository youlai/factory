...
class V3_OrderTableViewController2: UIViewController,UITableViewDelegate,UITableViewDataSource,EmptyViewProtocol {
    var showEmtpy: Bool{
        get {
    ...
    override func viewDidLoad() {
        ...
        uv_two.layer.maskedCorners=CACornerMask.init(rawValue: CACornerMask.layerMaxXMinYCorner.rawValue|CACornerMask.layerMaxXMaxYCorner.rawValue)
...
//        tableView.contentInset=UIEdgeInsets(top: 10, left: 0, bottom: 10, right: 0)
        ...
        loadData()
        //MARK:接收通知
        NotificationCenter.default.addObserver(self, selector: #selector(one_click), name: NSNotification.Name("接单成功"), object: nil)
    }
    init(status:Int){
