...
import Tabman
import Pageboy
class SubOrderViewController4: TabmanViewController,PageboyViewControllerDataSource, TMBarDataSource{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.index=0
        vcs.append(V3_OrderTableViewController3(status: 13))
