...
open class TTPageViewController: UIViewController {
    ...
    public init(controllers:[UIViewController], frame viewFrame:CGRect,delegate:TTPageViewControllerDelegate? = nil,currentIndex:Int) {
        ...
        scrollToPageAtIndex(currentIndex)
    }
